...
export const questions = [
  ...
  },
  {
    ...
    explainer: "This is about how consistently you meet task deadlines.",
    category: 'SYSTEMS',
    order: 4,
    knackFields: {
      current: 'field_797',
  ...
  },
  {
    ...
    explainer: "This is about how you generally see yourself day to day.",
    category: 'ATTITUDE',
    order: 8,
    knackFields: {
      current: 'field_801',
  ...
  },
  {
    ...
    explainer: "This is about how much consistent effort you feel you put into your studies.",
    category: 'EFFORT',
    order: 9,
    knackFields: {
      current: 'field_802',
  ...
  },
  {
    ...
    explainer: "This is about your typical track record with due dates.",
    category: 'SYSTEMS',
    order: 11,
    knackFields: {
      current: 'field_804',
  ...
  },
  {
    ...
    explainer: "This is about how much you generally enjoy picking up new knowledge or skills.",
    category: 'VISION',
    order: 16,
    knackFields: {
      current: 'field_809',
  ...
  },
  {
    ...
    explainer: "This is about how much you push to refine and improve your work.",
    category: 'EFFORT',
    order: 17,
    knackFields: {
      current: 'field_810',
  ...
  },
  {
    ...
    explainer: "This is about how useful and clear your notes usually are when you revisit them.",
    category: 'SYSTEMS',
    order: 18,
    knackFields: {
      current: 'field_811',
  ...
  },
  {
    ...
    explainer: "This is about how often you interleave different topics rather than doing one only.",
    category: 'PRACTICE',
    order: 19,
    knackFields: {
      current: 'field_812',
  ...
  },
  {
    ...
    explainer: "This is about how manageable current study pressures feel with your existing approaches.",
    category: 'ATTITUDE',
    order: 20,
    knackFields: {
      current: 'field_813',
  ...
  },
  {
    ...
    explainer: "This is about your typical effort level during lessons.",
    category: 'EFFORT',
    order: 21,
    knackFields: {
      current: 'field_814',
  ...
  },
  {
    ...
    explainer: "This is about how easy it is for you to find materials when you need them.",
    category: 'SYSTEMS',
    order: 22,
    knackFields: {
      current: 'field_815',
  ...
  },
  {
    ...
    explainer: "This is about how often you explain content out loud (to others or yourself) when revising.",
    category: 'PRACTICE',
    order: 23,
    knackFields: {
      current: 'field_816',
  ...
  },
  {
    ...
    explainer: "This is about how comfortable you feel asking public questions for clarification.",
    category: 'ATTITUDE',
    order: 24,
    knackFields: {
      current: 'field_817',
  ...
  },
  {
    ...
    explainer: "This is about how often you use active revision techniques and timed practice.",
    category: 'PRACTICE',
    order: 25,
    knackFields: {
      current: 'field_818',
  ...
  },
  {
    ...
    explainer: "This is about your belief about intelligence changing over time. Answer with your view.",
    category: 'ATTITUDE',
    order: 26,
    knackFields: {
      current: 'field_819',
  ...
  },
  {
    ...
    explainer: "This is about how willing you are to receive and use specific feedback.",
    category: 'ATTITUDE',
    order: 27,
    knackFields: {
      current: 'field_820',
  ...
  },
  {
    ...
    explainer: "This is about how well you feel you manage nerves during assessments.",
    category: 'ATTITUDE',
    order: 28,
    knackFields: {
      current: 'field_821',
  ...
  },
  {
    ...
    explainer: "This is about whether you have clear target grades in mind.",
    category: 'VISION',
    order: 29,
    knackFields: {
      current: 'field_2317',
  ...
  // 3 Outcome Questions (don't affect VESPA scores but are collected)
  {
    ...
    explainer: "This is about how adequate you feel your support network and resources are.",
    category: 'OUTCOME',
    order: 30,
    knackFields: {
      current: 'field_1816',
  ...
  },
  {
    ...
    explainer: "This is about how prepared you feel for the academic demands ahead.",
    category: 'OUTCOME',
    order: 31,
    knackFields: {
      current: 'field_1817',
  ...
  },
  {
    ...
    explainer: "This is about your current confidence in reaching your potential outcomes.",
    category: 'OUTCOME',
    order: 32,
    knackFields: {
      current: 'field_1818',
